...
enum CharacterData {
    static let all: [FriendCharInfo] = [
        ...
        FriendCharInfo(id: "bbiyak", name: "삐약",
            ...
            unlockDescription: "5개 완료", gridType: .a, palette: [
        ...
        FriendCharInfo(id: "bori", name: "보리",
            ...
            unlockDescription: "25개 완료", gridType: .a, palette: [
        ...
        FriendCharInfo(id: "red", name: "레드",
            ...
            unlockDescription: "75개 완료", gridType: .b, palette: [
        ...
        FriendCharInfo(id: "obsidian", name: "흑요석",
            ...
            unlockDescription: "150개 완료", gridType: .b, palette: [
        ...
        FriendCharInfo(id: "cloud", name: "구름이",
            ...
            unlockDescription: "250개 완료", gridType: .a, palette: [
        ...
        FriendCharInfo(id: "sprout", name: "새싹",
            ...
            unlockDescription: "500개 완료", gridType: .a, palette: [
        ...
        FriendCharInfo(id: "rainbow", name: "무지개",
            ...
            unlockDescription: "1000개 완료", gridType: .a, palette: [
        ...
        FriendCharInfo(id: "chrono", name: "시간",
            ...
            unlockDescription: "2000개 완료", gridType: .c, palette: [
